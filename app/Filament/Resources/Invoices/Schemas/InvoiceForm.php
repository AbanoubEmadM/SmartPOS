    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                \Filament\Schemas\Components\Section::make('معلومات الفاتورة')
                    ->columnSpan(1)
                    ->schema([
                        Placeholder::make('id')
                ...
                \Filament\Schemas\Components\Section::make('الطلب والمبيعات المرتبطة')
                    ->columnSpan(1)
                    ->schema([
            ...
            ->columns(2); // تقسيم الصفحة لعمودين متساويين عشان الكارتين يجوا جمب بعض
    }
}
